...
$PackageAuthors = "company"
$PackageOwners  = "Your Company S.A"
$PackageProjectUrl = "http://npsbuilder.com"
$PackageIconUrl = "http://npsbuilder.com/icon.png"
$PackageCopyright = "Copyright © npsbuilder 2015"		
$PackageLanguage = "pt-Br"		
$PackageTags = "example sample nuget powershell"		
...
Function Make-Nuget-Pack {
    ...
    Process {
        ...
        & $FullExeNuget Pack $NuspecPath -NoPackageAnalysis | Out-Null
